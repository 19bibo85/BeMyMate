			    ...
			    <div class="col-sm-10">
				    <div class="message clearfix">
                        ...
                        <div data-bind="visible: IsDeleteVisible"style="display:inline-block;">
                            <button data-bind="attr: { id: 'delete_id_' + review.ReviewId }, click: $parent.deleteReview.bind($data, review)">Delete</button>
                        </div>
