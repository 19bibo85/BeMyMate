CREATE TRIGGER [ProfileQuestionnaireObj]
	...
	BEGIN
		...
		WHILE(@InsNum > 0)
		BEGIN
			INSERT INTO [Security].[Object] (tableId) VALUES (13)
			DECLARE @objID INT = (SCOPE_IDENTITY());
			
			INSERT INTO [User].[ProfileQuestionnaire] (id, name, objectId, contextId, areaId)
